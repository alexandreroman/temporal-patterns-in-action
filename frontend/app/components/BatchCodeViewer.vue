...
const SOURCES: Record<CodeLang, BatchSource> = {
  go: {
    ...
    lines: [
      ...
      "    var a *Activities",
      "    // Run the 4 pipeline stages sequentially; stop on the first error so",
      "    // the parent counts this image as failed.",
  ...
  java: {
    ...
    lines: [
      ...
      "    // Run the 4 pipeline stages sequentially; first error stops the pipeline",
      "    // and the parent counts this image as failed.",
  ...
  python: {
    ...
    lines: [
      ...
      "        # Run the 4 pipeline stages sequentially; first ActivityError stops",
      "        # the pipeline and surfaces to the parent.",
