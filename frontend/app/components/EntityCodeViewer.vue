...
const SOURCES: Record<CodeLang, EntitySource> = {
  go: {
    ...
    hl: {
      ...
      "update-qty": [27, 27],
      "remove-item": [34, 34],
      "process-payment": [41, 44],
      "send-confirmation": [45, 47],
      getCart: [6, 10],
    },
  },
  java: {
    ...
    hl: {
      ...
      "update-qty": [39, 39],
      "remove-item": [43, 43],
      "process-payment": [47, 48],
      "send-confirmation": [49, 49],
      getCart: [57, 61],
    },
  },
  typescript: {
    ...
    hl: {
      ...
      "update-qty": [38, 38],
      "remove-item": [42, 42],
      "process-payment": [46, 47],
      "send-confirmation": [48, 48],
      getCart: [23, 26],
    },
  },
  python: {
    ...
    hl: {
      ...
      "update-qty": [41, 42],
      "remove-item": [45, 46],
      "process-payment": [49, 51],
      "send-confirmation": [52, 54],
      getCart: [22, 26],
    },
  },
};
