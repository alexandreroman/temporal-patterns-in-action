...
// workflows and activities. Returns only on failure or interrupt.
func RunWorker(pattern, taskQueue string, register func(w worker.Worker, publisher Publisher)) {
	...
	w := worker.New(c, taskQueue, worker.Options{
		Interceptors: []interceptor.WorkerInterceptor{NewInterceptor(publisher, pattern)},
	})
